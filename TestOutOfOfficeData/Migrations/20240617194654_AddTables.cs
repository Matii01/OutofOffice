        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaverRequest = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeInProject", x => x.ID);
                    table.ForeignKey(
                        name: "FK_EmployeeInProject_Employees_EmployeeID",
                        column: x => x.EmployeeID,
                        principalTable: "Employees",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeInProject_Projects_ProjectID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeInProject_EmployeeID",
                table: "EmployeeInProject",
                column: "EmployeeID");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeInProject_ProjectID",
                table: "EmployeeInProject",
                column: "ProjectID");
        }
